...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'perfil/password', component: () => import('@/modules/auth/pages/ChangePasswordPage.vue') },
      { path: 'wallet', name: 'UserWallet', component: () => import('@/modules/wallet/pages/WalletPage.vue') },
